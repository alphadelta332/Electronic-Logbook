...
public static class PortableLogbookPackage
{
        ...
        LogbookId? expectedLogbookId = null)
    {
        ...
        try
        {
            manifest = JsonSerializer.Deserialize<PortableLogbookPackageManifest>(manifestBytes, PortableLogbookJson.SerializerOptions)
    ...
    {
        ArgumentNullException.ThrowIfNull(key);
        return Read(packageBytes, key.ToBytes(), expectedLogbookId);
    }
