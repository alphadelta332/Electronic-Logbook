...
- Keep every master-workbook VBA source change paired with the corresponding `Electronic_Logbook_Master.xlsm` change. After editing tracked VBA source, run `tools/ImportVbaIntoWorkbook.ps1`; string-only and other small VBA edits still require import.
