...
Gradle applies this descriptor only to the permanent-package `preview` variant. Debug
and acceptance builds deliberately skip it because their `.dev` and `.acceptance`
package suffixes are not registered Firebase Android apps.
